...
<!-- Mirrored from risingtheme.com/html/demo-grocee/grocee/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Sep 2022 05:04:49 GMT -->
<head>
  <meta charset="utf-8">
                    ...
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="Logout.php"> 
                                       Sign Out
                                    </a>  
                                </li>
                            ...
                            <li class="header__account--items d-none d-lg-block">
                                <a class="header__account--btn"  href="Wishlist.php">
                                    ...
                                    <?php
                                        ...
                                        $wishlist = mysqli_num_rows($select_wishlist);

                                    ?>
                                    <span class="items__count"><?php echo $wishlist; ?>  </span> 
                                </a>
                            </li>
                            <li class="header__account--items d-none d-lg-block">
                                <a class="header__account--btn" href="Register.php">
                                ...
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16.706" height="15.534" viewBox="0 0 14.706 13.534">
                                      ...
                                      <?php
                                        ...
                                        <span class="items__count"> <?php echo $row_count; ?>  </a></span> 
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="Register.php">My Account</a></li>
         ...
         ?>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="Image/<?php echo $fetch_cart['Product_Image']; ?>" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="#"><?php echo $fetch_cart['Product_Name']; ?></a></h4>
                        ...
                        <div class="minicart__text--footer d-flex align-items-center">
                            ...
                            <a href="cart.php?remove=<?php echo $fetch_cart['ID']; ?>" onclick="return confirm('remove item from cart?')"  class="minicart__product--remove" type="button">  Remove  </a> 
                        </div>
                    </div>
                </div>
                ...
                <?php
                $sub_total = (int)($fetch_cart['Product_Price'] * (int)$fetch_cart['Product_Qty']);
            ...
            <div class="minicart__amount_list d-flex justify-content-between">
                    <span>Total:</span>
                    <span><b>Rs: <?php echo $grand_total ?></b></span>
                </div>

            <div class="minicart__button d-flex justify-content-center">
                <a class="btn minicart__button--link" href="cart.php">View cart</a>

                                                         <?php 
                                                        if(empty($_SESSION['U_Id']))
                                                        {
                                                        echo' <a class="btn minicart__button--link" href="Login.php">Checkout</a>';
                                                        }
                                                        else if(mysqli_num_rows($select_cart) > 0){
                                                            echo' <a class="btn minicart__button--link" href="checkout.php">Checkout</a>';
                                                        }
                                                        else{
                                                            echo' <a class="btn minicart__button--link" href="Shop.php">Checkout</a>';
                                                        }
                                                        ?>
