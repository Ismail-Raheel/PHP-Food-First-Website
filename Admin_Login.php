...
if(isset($_POST['login']))
{
   ...
   $result = mysqli_query($conn,"SELECT * FROM admin WHERE Admin_Email = '$uname' OR Admin_Password = '$pass'");
   $row = mysqli_fetch_assoc($result);


   if(mysqli_num_rows($result) > 0) 
   {
      if($uname == $row['Admin_Email'] && $pass == $row['Admin_Password'])
      {
        $_SESSION['Login'] = TRUE;
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                <form action="Admin_Login.php" method="post" enctype="multipart/form-data">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        // if(!empty($error))
                        //     echo "<p style='color: red;font:500'>*</p>";
                        // else
                        //     echo "*";
                            ?>
