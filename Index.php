...
$sql = "SELECT * 
from  products 
WHERE Discount_Price > 1 AND Discount_Date > NOW()";
$Res = $conn -> query($sql); 
...
// $sql1 = "SELECT * 
// from  products 
// WHERE Discount_Price > 1 AND '2023-10-21 19:20:00' < $date";
...
?>
    ...
    <main class="main__content_wrapper">
                    ...
                    <div id="product_all" class="tab_pane active show">
                        <div class="product__section--inner">
                         ...
                         <?php
                            ...
                            while($ac = $New_Arrivals -> fetch_assoc())
                            {
                            ?>
                                ...
                                <div class="col md-28">
                                    <div class="product__items product__items2">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.html" style="width: 250px;;height:250px;">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="product-details.html"><?php echo $ac['Product_Name'];?> </a></h3>
                                            ...
                                            <div class="product__items--rating d-flex justify-content-center align-items-center">
                                                ...
                                                <span class="product__items--rating__count--number">(<?php echo $ac['Product_Qty'];?>)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items">
                                <div class="product__items--thumbnail" style="width:250px;height: 250px;">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="Image/<?php echo $ac['Product_Image'];?>" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="Image/<?php echo $ac['Product_sub_img'];?>" alt="product-img">
                                    </a>
                                    ...
                                    <div class="deals__product--countdown d-flex"  data-countdown="<?php echo $ac['Discount_Date'];?>" id="countdown"></div>
       ...
       <script>
        ...
        // var countdownElements = document.querySelectorAll('.deals__product--countdown');
        // for (var i = 0; i < countdownElements.length; i++) {
        //         var countdownValue = countdownElements[i].getAttribute("data-countdown");
        // }
        ...
        // if (countdownValue <= customFormat) {
        //     setTimeout(function() {
        //         location.reload();
        //     },1000);     
        // }
                                ...
                                <div class="product__items--content text-center">
                                    ...
                                    <?php
                                        ...
                                        // if($ac["Discount_Price"] <= 0 && $ac['Discount_Date'] < $date)
                                        // {
