...
if(isset($_POST['update_update_btn'])){
    ...
    $update_quantity_query = mysqli_query($conn, "UPDATE cart SET Product_Qty = '$update_value'  WHERE ID = '$update_id'");
                                ...
                                <div class="cart__table">
                                    <table class="cart__table--inner">
                                        ...
                                        ?>
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <a href="cart.php?remove=<?php echo $fetch_cart['ID']; ?>" onclick="return confirm('remove item from cart?')" class="delete-btn"> <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="16px" height="16px"><path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z"/></svg>     </a> 
                                                        </button>
                                                ...
                                                <td class="cart__table--body__list">
                                                        ...
                                                        ?>
                                                        <span class="cart__price"><?php echo number_format($fetch_cart['Product_Price']); ?></span>
                                                        <?php 
                                                        }
                                                        else{
                                                        ?>  
                                                        <span class="cart__price">Rs: <?php echo $fetch_cart["Discount_Price"];?> </span>  
                                                ...
                                                <td class="cart__table--body__list">
                                                    <div class="quantity__box">
                                                        ...
                                                        <label>
                                                            <input type="number" name="update_quantity"  class="quantity__number quickview__value--number" min="1"   value="<?php echo $fetch_cart['Product_Qty']; ?>"  data-counter />
                                                        </label>
                                                ...
                                                <td class="cart__table--body__list">
                                                        ...
                                                        ?>
                                                        <span class="cart__price end"> <?php echo $sub_total = (int)($fetch_cart['Product_Price'] * (int)$fetch_cart['Product_Qty']); ?></span>
                                                        ...
                                                        <span class="cart__price end"> <?php echo $sub_total = (int)($fetch_cart['Discount_Price'] * (int)$fetch_cart['Product_Qty']); ?></span>
                                            ...
                                            <td class="cart__table--body__list">
                                            <input type="submit" value="update"  class="cart__summary--footer__btn btn checkout" name="update_update_btn">
                                            </td>
                                            </tr>
                                            </form>
                                    ...
                                    <div class="continue__shopping d-flex justify-content-between">
                                        ...
                                        if(mysqli_num_rows($select_cart) > 0)
                                        {
                                        echo '<a href="cart.php?delete_all" onclick="return confirm("are you sure you want to delete all?");" class="continue__shopping--clear"> <i class="fas fa-trash"></i> Clear Cart </a>';
                                        }
                                        else
                                        {
                                    ...
                                    <div class="cart__summary--total mb-20">
                                        <table class="cart__summary--total__table">
                                            <tbody>
                                                ...
                                                <tr class="cart__summary--total__list">
                                                    <td class="cart__summary--total__title text-left">SUBTOTAL TOTAL</td>
                                                    <td class="cart__summary--amount text-right">Rs: <?php echo $grand_total; ?></td>
                                    ...
                                    <div class="cart__summary--footer">
                                        ...
                                        <ul class="d-flex justify-content-between">
                                            ...
                                            <!-- <li><button class="cart__summary--footer__btn btn cart" type="submit">Update Cart</button></li> -->
                                                        ...
                                                        {
                                                        echo'<li><a class="cart__summary--footer__btn btn checkout" href="Login.php">Check Out</a></li>';
                                                        }
                                                        else if(mysqli_num_rows($select_cart) > 0){
                                                            echo'<li><a class="cart__summary--footer__btn btn checkout" href="checkout.php">Check Out</a></li>';
                                                        }
                                                        else{
                                                            echo'<li><a class="cart__summary--footer__btn btn checkout" href="Shop.php">Check Out</a></li>';
                                                        }
                                                        ?>
